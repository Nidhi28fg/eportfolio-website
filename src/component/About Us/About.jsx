  ...
  return (
    <div>
      <div className="flex w-full justify-center items-center mt-10">
        <p className="w-[526px] h-[366px] rotate-0 opacity-100 font-alexandria font-semibold text-[50px] leading-[100%] tracking-[2%] text-center">
            “Every student, regardless of their background, deserves a real chance at success.”
        </p>
      </div>
      <div className="flex justify-between">
        <div><p className="font-alexandria font-normal text-[72.36px] leading-[100%] tracking-[0%] text-center">The EpochFolio, 
we are not just tackling the problem of poor placements — we’re redefining what’s possible for millions of students who’ve been overlooked, underserved, and underestimated by the traditional system.</p></div>
        <div></div>
      </div>
